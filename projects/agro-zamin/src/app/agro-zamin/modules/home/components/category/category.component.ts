...
export class CategoryComponent implements OnInit {
  categoryCard: CategoryCard[] = [
    ...
    {
      img: './assets/images/agrozamin/cow.svg',
      text: 'Сельско-хозяйственные животные',
    },
    ...
    {
      img: './assets/images/agrozamin/shield.svg',
      text: 'Средства защиты растений',
    },
    {
      img: './assets/images/agrozamin/tech.svg',
      text: 'Фермерское оборудование',
    },
    {
      img: './assets/images/agrozamin/rubber.svg',
      text: 'Резинотехнические изделия',
    },
