...
export class HistoryComponent implements OnInit {
  ...
  storys = [
    { id: 1, img: './assets/images/agrozamin/history-card-1.jpg' },
    { id: 2, img: './assets/images/agrozamin/history-card-2.jpg' },
    { id: 3, img: './assets/images/agrozamin/history-card-3.jpg' },
    { id: 4, img: './assets/images/agrozamin/history-card-1.jpg' },
    { id: 5, img: './assets/images/agrozamin/history-card-2.jpg' },
    { id: 6, img: './assets/images/agrozamin/history-card-3.jpg' },
    { id: 7, img: './assets/images/agrozamin/history-card-1.jpg' },
    { id: 8, img: './assets/images/agrozamin/history-card-2.jpg' },
  ];
